...
import 'package:doctor_ui/model/speciality.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<String> categories = ["Yetişkin","Çocuk","Kritik","Acil"];
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 20,),
              Text("Son Randevuların", style: TextStyle(
                  color: Colors.black87.withOpacity(0.8),
                  fontSize: 25,
                  fontWeight: FontWeight.w600
              ),),
...
class CategorieTile extends StatefulWidget {
  ...
  CategorieTile({Key? key, required this.categorie, required this.isSelected,required this.context}) : super(key: key);
...
class SpecialistTile extends StatelessWidget {
  ...
  const SpecialistTile({required this.imgAssetPath,required this.speciality
